...
INSERT INTO stories (creator_id, title, contents, date_created, complete)
VALUES (3, 'Spy x Family', 'In order to maintain the state of peace between the rival nations of Westalis and Ostania, a Westalian agent code-named "Twilight" is tasked with spying on Donovan Desmond, leader of the National Unity Party within Ostania.', '2019-03-25', FALSE);
INSERT INTO stories (creator_id, title, contents, date_created, complete)
